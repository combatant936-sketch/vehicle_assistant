...
| **Groq API** | LLM inference API running models such as `llama-3.1-8b-instant` or `openai/gpt-oss-120b` with support for structured output parsing. |
...
- **Multi-Model Support**: Configurable AI models including `llama-3.1-8b-instant` and `openai/gpt-oss-120b` via Groq API.
